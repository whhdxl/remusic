...
import com.av.remusic.widget.LvMenuItem;
...
public class MenuItemAdapter extends BaseAdapter {
    ...
    private List<LvMenuItem> mItems = new ArrayList<LvMenuItem>(
            Arrays.asList(
                    new LvMenuItem(R.mipmap.topmenu_icn_night, "Night Mode"),
                    new LvMenuItem(R.mipmap.topmenu_icn_skin, "Themes"),
                    new LvMenuItem(R.mipmap.topmenu_icn_time, "Sleep Timer"),
//                    new LvMenuItem(R.mipmap.topmenu_icn_vip, "下载歌曲品质"),
                    new LvMenuItem(R.mipmap.topmenu_icn_exit, "Exit")
